...
public class DrawIfAttribute : PropertyAttribute
{
    ...
    public bool negateComparison { get; private set; }
    ...
    public DrawIfAttribute(string comparedPropertyName, object comparedValue, bool negateComparison = false, DisablingType disablingType = DisablingType.DontDraw)
    {
        this.comparedPropertyName = comparedPropertyName;
        this.comparedValue = comparedValue;
        this.disablingType = disablingType;
        this.negateComparison = negateComparison;
    }
}