...
public class stripeGenerateEditor : Editor
{
    ...
    public override void OnInspectorGUI() {
		...
		if(m_Target.myStrength!=preStrength){
    ...
    private void handleStrength(){ 
    	m_Target.width = (int) (0 + (int)(120f)*m_Target.myStrength);
    	m_Target.length = 1+(1.5f-1f)*m_Target.myStrength ;

    	m_Target.density = (int) (1 + (int)(3f-1f)*m_Target.myStrength);
